...
class Client(object):
    ...
    MARGIN_API_URL = 'http://api.binance.com/sapi'
    ...
    def _create_api_uri(self, path, signed=True, version=PUBLIC_API_VERSION):
        v = self.PRIVATE_API_VERSION if signed else version  # v1
    ...
    def get_symbol_depth(self, **params):
        """
        深度信息
        """
    ...
    def cancel_order_all(self, **params):
        """Cancel an active order. Either orderId or origClientOrderId must be sent.
    ...
    def get_capital_deposit_hisrec(self, **params):
        """
        [
              {
                "counterParty":"master",
