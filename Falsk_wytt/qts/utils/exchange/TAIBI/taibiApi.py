...
class CTB(object):
    ...
    def cancel_all_orders(self, symbol):
        """撤销当前币对所有挂单"""
        try:
            os = self.get_orderids(symbol)
            self.cancel_orders(os)
        except Exception as e:
            print("cancel_all_orders error".format(e))
...
if __name__ == "__main__":
    ...
    # print("---os", os)
    # print(len(os))
    # buyid = tb.Sell('WTC/USDT',  0.5, 10)
    # print("---buyid", buyid)
    # tb.cancel_order(1319284241808240640)

    # print(tb.get_order(buyid))
    # id_list = [1417315837169119232]
    # res = tb.cancel_orders(id_list)
    # print(res)
    ...
    signString = "gameId={}&token={}&ts={}".format("tf", protected, time_date)
    print("----:",signString)
    a.update(signString.encode('utf-8'))
    sign = a.hexdigest()
    print(sign)
