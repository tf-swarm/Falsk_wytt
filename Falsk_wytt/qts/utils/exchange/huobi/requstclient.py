...
my_path = dirname(os.path.abspath(__file__))
...
from qts.utils.exchange.huobi.constant.system import RestApiDefine
from qts.utils.exchange.huobi.impl.restapirequestimpl import RestApiRequestImpl
from qts.utils.exchange.huobi.impl.restapiinvoker import call_sync
...
from qts.utils.exchange.huobi.model.balance import Balance
from qts.utils.exchange.huobi.model.deposithistory import DepositHistory
...
class RequestClient(object):
    ...
    def get_trades_list(self, symbol: 'str', types=None, start_time: 'int' = None, end_time: 'int' = None, from_id: 'int' = None, direct=None, size: 'int' = None) -> list:
        """
        get market tickers

        :return: market ticker list.
        """
        return call_sync(self.request_impl.get_trades_list(symbol, types, start_time, end_time, from_id, direct, size))
    ...
    def get_account_balance(self) -> list:
        ...
        for item in accounts:
            ...
            #print(balance_url, item.id, account_balance_map)
    ...
    def get_open_orders(self, symbol: 'str', account_type: 'AccountType' = 'spot', side: 'OrderSide' = None,
    ...
    def cancel_order(self, order_id: object) -> object:
        ...
        :return: No return
        """
        call_sync(self.request_impl.cancel_order(order_id))
    ...
    def get_user_list(self, from_id: 'int' = None) -> list:
        """
        Get the withdraw records of an account.
        ...
        :return: The list of withdraw records.
        """
        return call_sync(self.request_impl.get_sub_user_list(from_id))
...
if __name__ == '__main__':
    ...
    ticker = request_client.get_best_quote('btcusdt')
    print(ticker.bid_price,ticker.last_price)
